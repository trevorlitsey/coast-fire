...
export default function ResultsGrid({ results, gapAnalysis, targetPortfolio }: ResultsGridProps) {
  return (
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b-2 border-gray-200">
              ...
              <th className="text-right py-3 px-2 font-semibold text-gray-700">Future Value</th>
              <th className="text-right py-3 px-2 font-semibold text-gray-700">After-Tax</th>
              <th className="text-center py-3 px-2 font-semibold text-gray-700">Status</th>
              <th className="text-right py-3 px-2 font-semibold text-gray-700">One-Time</th>
              <th className="text-right py-3 px-2 font-semibold text-gray-700">Monthly</th>
              <th className="text-right py-3 px-2 font-semibold text-gray-700">Annual</th>
            </tr>
